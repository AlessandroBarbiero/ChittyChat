...
func (x *chatChatClient) Send(m *RequestMsg) error {
	return x.ClientStream.SendMsg(m)
}

func (x *chatChatClient) Recv() (*ResponseMsg, error) {
	m := new(ResponseMsg)
...
func (x *chatChatServer) Send(m *ResponseMsg) error {
	return x.ServerStream.SendMsg(m)
}

func (x *chatChatServer) Recv() (*RequestMsg, error) {
	m := new(RequestMsg)
